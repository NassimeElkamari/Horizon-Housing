...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="flex flex-col items-center justify-center min-h-screen bg-blue-50 bg-cover bg-center" style={{ backgroundImage: "url('/path/to/your/background-image.jpg')" }}>
