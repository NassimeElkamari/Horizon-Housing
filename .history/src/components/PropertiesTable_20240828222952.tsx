    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      {selectedProperty === null ? (
          ...
          <table className="min-w-full bg-white border border-gray-200 mb-6 rounded-lg shadow-md">
            <thead>
              <tr>
                ...
                <th className="px-4 py-2 border-b text-black text-left text-center">Number of Units</th>
        ...
        <TenantManagement
          ...
          propertyName={selectedProperty.name} // Pass property name
          onBack={() => setSelectedProperty(null)} // Handle going back to properties table
        />
      )}
    </div>
  );
