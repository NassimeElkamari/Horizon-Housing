...
interface TenantManagementProps {
  ...
  onShowProperties: () => void; // New prop to handle showing the properties table
}

const TenantManagement = ({ propertyId, propertyName, onShowProperties }: TenantManagementProps) => {
  ...
  return (
    <div className="p-6">
      ...
      <h3 className="text-xl font-semibold mb-2 text-black">Tenants for {propertyName}</h3>
