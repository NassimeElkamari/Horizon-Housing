...
const TenantManagement = () => {
  ...
  useEffect(() => {
    // Fetch properties and tenants when component mounts
  ...
  return (
    <div className="p-6">
      ...
      {selectedProperty && (
        <div>
          <h3 className="text-xl font-semibold mb-2">Tenants for Selected Property</h3>
          <table className="min-w-full bg-white border border-gray-200 mb-6">
            <thead>
              <tr>
                <th className="px-4 py-2 border-b">Name</th>
                <th className="px-4 py-2 border-b">Contact Details</th>
            ...
            <tbody>
              {tenants.map((tenant) => (
                <tr key={tenant.id}>
                  ...
                  <td className="px-4 py-2 border-b">{tenant.contact_details}</td>
