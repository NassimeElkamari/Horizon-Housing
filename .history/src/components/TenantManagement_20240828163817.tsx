...
interface Property {
  ...
  rental_cost?: number;
  tenants?: Tenant[]; // add tenants to the property for display
}
      ...
      <div>
        {properties.map((property) => (
          <div key={property.id} className="mb-6 p-4 border rounded-md">
            ...
            <p className="text-gray-600 mb-2">Number of Units: {property.number_of_units ?? 'N/A'}</p>
            <p className="text-gray-600 mb-2">Rental Cost: ${property.rental_cost?.toFixed(2) ?? 'N/A'}</p>
